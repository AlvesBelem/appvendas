...
class MyFirebase():
    API_KEY = "AIzaSyCN5LQMTETVvYFT75t-quWzATFDX4rt7Kg"
    ...
    def criar_conta(self, email, senha):
        ...
        if requisicao.ok:
            ...
            req_id = requests.get(f"https://aplicativosvendashash-22f77-default-rtdb.firebaseio.com/proximo_id_vendedor.json?auth={id_token}")
            id_vendedor = req_id.json()

            link = f"https://aplicativosvendashash-22f77-default-rtdb.firebaseio.com/{local_id}.json?auth={id_token}"
            ...
            requests.patch(f"https://aplicativosvendashash-22f77-default-rtdb.firebaseio.com/.json?auth={id_token}", data=inf_id_vendedor)
